package net.ck.util.astar.broken;
...
public class AStar_Backup
{
    ...
    public AStar_Backup(int rows, int cols, Node initialNode, Node finalNode, int hvCost, int diagonalCost)
    {
        this.hvCost = hvCost;
    ...
    public AStar_Backup(int rows, int cols, Node initialNode, Node finalNode)
    {
