...
@Getter
@Setter
public class ChatInputFieldListener implements ActionListener
{
    ...
    public ChatInputFieldListener(TalkDialog dialog, JTextField textField, JTextArea textArea, LifeForm n)
    {
